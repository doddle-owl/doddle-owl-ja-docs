...
.. [Buitelaar04] P\. Buitelaar, "OntoSelect: Towards the Integration of an Ontology Library, Ontology Selection and Knowledge Markup," Proceedings of the Workshop on Knowledge Markup and Semantic Annotation (Semannot2004), 2004.
.. [Ding05] L\. Ding, R. Pan, T. Finin, A. Joshi, Y. Peng, and P. Kolari, "Finding and Ranking Knowledge on the Semantic Web,"Proceedings of the 4th International Semantic Web Conference, LNCS 3729, pp.156-170, 2005.
...
.. [hommeaux08] E\. Prud’hommeaux, and A. Seaborne, "SPARQL Query Language for RDF," W3C Recommendation, 2008. `[link] <https://www.w3.org/TR/rdf-sparql-query/>`__
...
.. [Miles05] A\. Miles, and D. Brickley, "SKOS Core Guide," , 2005. `[link] <https://www.w3.org/TR/swbp-skos-core-guide/>`__
...
.. [Nakagawa03] 中川裕志，森辰則，湯本紘彰，"出現頻度と連接頻度に基づく専門用語抽出，" 自然言語処理，vol.10，no.1，pp.29–35，2003. `[link] <http://gensen.dl.itc.u-tokyo.ac.jp/>`__
.. [Nakayama06] 中山浩太郎，原隆浩，西尾章治郎，"Wikipedia マイニングによるシソーラス辞書構築手法，"情報処理学会論文誌，vol.47，no.10，pp.2917-2928，2006.
.. [Page98] L\. Page, S. Brin, R. Motwani, and T. Winograd, "The PageRank Citation Ranking: Bringing Order to the Web," Technical report, Stanford Digital Library Technologies Project, 1998.
...
.. [Yokoi95] T\. Yokoi, "The EDR Electronic Dictionary," Commun. ACM, vol.38, no.11, pp.42-44, 1995. `[link] <https://www2.nict.go.jp/ipp/EDR/JPN/J_indexTop.html>`__